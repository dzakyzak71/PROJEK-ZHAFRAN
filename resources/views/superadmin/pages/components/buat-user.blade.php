...
<div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md mb-8">
    <h2 class="text-2xl font-semibold text-gray-800 mb-4">👤 Buat Akun User</h2>
    ...
    <form action="{{ route('superadmin.simpan-user') }}" method="POST">
        @csrf
...
<h2 class="text-xl font-semibold text-gray-800 mb-4">📋 Daftar Akun User</h2>
    ...
    <tbody class="text-gray-700">
        ...
        <tr class="border-b">
            ...
            <td class="px-6 py-4 flex gap-2">
                <a href="{{ route('superadmin.edit-user', $user->id) }}" class="text-blue-600 hover:underline">Edit</a>
                <form action="{{ route('superadmin.hapus-user', $user->id) }}" method="POST" onsubmit="return confirm('Yakin ingin hapus user ini?')">
                    @csrf
                    @method('DELETE')
